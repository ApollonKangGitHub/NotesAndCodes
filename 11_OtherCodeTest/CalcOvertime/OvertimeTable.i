...
static unsigned char get_format_char_number(char * src, char format);
static void calc_over_time( int fdi, int fdo);
...
static int add_dayInfo_to_overtimeInfo(OVERTIEINFO * overtimeInfo, DAYINFO * dayInfo);
static void save_overtime_info(OVERTIEINFO * overtimeInfo, int fd);
...
# 52 "OvertimeTable.c"
 ...
 fdi = open(filei, 
# 59 "OvertimeTable.c" 3 4
                  00
# 59 "OvertimeTable.c"
                          );
 fdo = open(fileo, 
# 60 "OvertimeTable.c" 3 4
                  0100 
# 60 "OvertimeTable.c"
                          | 
# 60 "OvertimeTable.c" 3 4
...
void calc_over_time( int fdi, int fdo)
{
 char overtimeTable[1024] = {0};
 char dayInfoBuff[32] = {0};
 int ret = (-1);
...
# 82 "OvertimeTable.c"
 ...
 ret = read(fdi, pOverTime, 1024);
 if(ret < 0){
  printf("\nRead file failure!\n");
  exit(
# 90 "OvertimeTable.c" 3 4
      1
# 90 "OvertimeTable.c"
                  );
 }
...
unsigned char get_format_char_number(char * src, char format)
{
 unsigned char num = 0;
 while(*src){
  if(*src++ == '#'){
...
void reset_day_info(DAYINFO * dayInfo)
{
 ...
 dayInfo->holidayFlag = (0);
 dayInfo->adjustFlag = (0);
 dayInfo->hours = 0;
 dayInfo->minutes = 0;
 dayInfo->sleepTime = 0;
 dayInfo->exceptionFlag = (0);
...
int add_dayInfo_to_overtimeInfo(OVERTIEINFO * overtimeInfo, DAYINFO * dayInfo)
{
 if(dayInfo->dayIndex > 31
  || !overtimeInfo
  || !dayInfo){
  return (-1);
 }
...
void save_overtime_info(OVERTIEINFO * overtimeInfo, int fd)
{
 int i = 0;
 FILE * fp = fdopen(fd, "w+");
...
{
 char * pMove = 
# 233 "OvertimeTable.c" 3 4
               ((void *)0)
# 233 "OvertimeTable.c"
                   ;
 char * saveptr = 
# 234 "OvertimeTable.c" 3 4
                 ((void *)0)
# 234 "OvertimeTable.c"
                     ;
 ...
 { if(gFunDbgFlag){ printf("\n%%OVERTIME-FUN-DBG:%s-%d-%s", __FUNCTION__, 242, "SATRT\n"); }};


 { char * ptr = 
# 245 "OvertimeTable.c" 3 4
((void *)0)
# 245 "OvertimeTable.c"
; pMove = strtok_r(dayInfoStr, ",", &saveptr); if(pMove){ dayInfo->dayIndex = 1*atoi(pMove); if(gInfoDbgFlag){ ptr = get_str_elements("dayInfo->dayIndex", '>'); printf("%s:%d ", ptr, atoi(pMove)); } } }
                                                             ;


 { char * ptr = 
# 249 "OvertimeTable.c" 3 4
((void *)0)
# 249 "OvertimeTable.c"
; pMove = strtok_r(
# 249 "OvertimeTable.c" 3 4
((void *)0)
# 249 "OvertimeTable.c"
, ",", &saveptr); if(pMove){ dayInfo->week = 1*atoi(pMove); if(gInfoDbgFlag){ ptr = get_str_elements("dayInfo->week", '>'); printf("%s:%d ", ptr, atoi(pMove)); } } }
                                                   ;


 { char * ptr = 
# 253 "OvertimeTable.c" 3 4
((void *)0)
# 253 "OvertimeTable.c"
; pMove = strtok_r(
# 253 "OvertimeTable.c" 3 4
((void *)0)
# 253 "OvertimeTable.c"
, ":", &saveptr); if(pMove){ dayInfo->startTimeStamp = 60*atoi(pMove); if(gInfoDbgFlag){ ptr = get_str_elements("dayInfo->startTimeStamp", '>'); printf("%s:%d ", ptr, atoi(pMove)); } } }
                                                              ;
 { char * ptr = 
# 255 "OvertimeTable.c" 3 4
((void *)0)
# 255 "OvertimeTable.c"
; pMove = strtok_r(
# 255 "OvertimeTable.c" 3 4
((void *)0)
# 255 "OvertimeTable.c"
, "-", &saveptr); if(pMove){ dayInfo->startTimeStamp += 1*atoi(pMove); if(gInfoDbgFlag){ ptr = get_str_elements("dayInfo->startTimeStamp", '>'); printf("%s:%d ", ptr, atoi(pMove)); } } }
                                                              ;


 { char * ptr = 
# 259 "OvertimeTable.c" 3 4
((void *)0)
# 259 "OvertimeTable.c"
; pMove = strtok_r(
# 259 "OvertimeTable.c" 3 4
((void *)0)
# 259 "OvertimeTable.c"
, ":", &saveptr); if(pMove){ dayInfo->endTimeStamp = 60*atoi(pMove); if(gInfoDbgFlag){ ptr = get_str_elements("dayInfo->endTimeStamp", '>'); printf("%s:%d ", ptr, atoi(pMove)); } } }
                                                            ;
 { char * ptr = 
# 261 "OvertimeTable.c" 3 4
((void *)0)
# 261 "OvertimeTable.c"
; pMove = strtok_r(
# 261 "OvertimeTable.c" 3 4
((void *)0)
# 261 "OvertimeTable.c"
, ",", &saveptr); if(pMove){ dayInfo->endTimeStamp += 1*atoi(pMove); if(gInfoDbgFlag){ ptr = get_str_elements("dayInfo->endTimeStamp", '>'); printf("%s:%d ", ptr, atoi(pMove)); } } }
                                                            ;


 { char * ptr = 
# 265 "OvertimeTable.c" 3 4
((void *)0)
# 265 "OvertimeTable.c"
; pMove = strtok_r(
# 265 "OvertimeTable.c" 3 4
((void *)0)
# 265 "OvertimeTable.c"
, ",", &saveptr); if(pMove){ dayInfo->adjustFlag = 1*atoi(pMove); if(gInfoDbgFlag){ ptr = get_str_elements("dayInfo->adjustFlag", '>'); printf("%s:%d ", ptr, atoi(pMove)); } } }
                                                         ;


 { char * ptr = 
# 269 "OvertimeTable.c" 3 4
((void *)0)
# 269 "OvertimeTable.c"
; pMove = strtok_r(
# 269 "OvertimeTable.c" 3 4
((void *)0)
# 269 "OvertimeTable.c"
, "\n", &saveptr); if(pMove){ dayInfo->holidayFlag = 1*atoi(pMove); if(gInfoDbgFlag){ ptr = get_str_elements("dayInfo->holidayFlag", '>'); printf("%s:%d ", ptr, atoi(pMove)); } } }
                                                           ;

 { if(gFunDbgFlag){ printf("\n%%OVERTIME-FUN-DBG:%s-%d-%s", __FUNCTION__, 272, "END\n"); }};
}

void calc_day_overtime_info_from_base_info(DAYINFO * dayInfo)
{
 unsigned int workTimes = 0;
 unsigned int sleepTimes = 0;

 { if(gFunDbgFlag){ printf("\n%%OVERTIME-FUN-DBG:%s-%d-%s", __FUNCTION__, 280, "SATRT\n"); }};
 ...
 if(!(dayInfo->startTimeStamp && dayInfo->endTimeStamp)
  ...
  if(!dayInfo->holidayFlag){
   dayInfo->exceptionFlag = (1);
  }
  return;
 }

 if((dayInfo->adjustFlag)
  || (!dayInfo->holidayFlag)
  && (dayInfo->week >= weekMonday)
  && (dayInfo->week <= weekFriday)){

  workTimes = ((18*60) - (8*60+30) - ((13*60+30) - (12*60)));

  if((dayInfo->startTimeStamp > (9*60))
   || (dayInfo->endTimeStamp < (18*60))){
  ...
  if((dayInfo->startTimeStamp > (8*60+30))){

   dayInfo->reboundTime = (dayInfo->startTimeStamp > ((8*60+30) + 15))
    ? (((8*60+30) + 30) - (8*60+30))
    : (((8*60+30) + 15) - (8*60+30));
  }


  if(dayInfo->endTimeStamp > (20*60+30)){

   dayInfo->sleepTime = (((13*60+30) - (12*60)) + ((18*60+45) - (18*60)));
  }
  else{

   dayInfo->sleepTime = ((13*60+30) - (12*60)) + dayInfo->endTimeStamp - (18*60);
  }
 }
 else{
  ...
  if(dayInfo->startTimeStamp >= (12*60)){

   if(dayInfo->endTimeStamp <= (13*60+30)){
    dayInfo->exceptionFlag = (1);
    return;
   }
   else{

    dayInfo->sleepTime = (dayInfo->startTimeStamp <= (13*60+30))
         ? ((13*60+30) - dayInfo->startTimeStamp)
         : 0;
   }
  }
  else if(dayInfo->endTimeStamp <= (13*60+30)){

   dayInfo->sleepTime = (dayInfo->endTimeStamp >= (12*60))
        ? (dayInfo->endTimeStamp - (12*60))
        : 0;
  }
  else{

   dayInfo->sleepTime = ((13*60+30) - (12*60));
  }
 }

 dayInfo->minutes = dayInfo->endTimeStamp
      - ((dayInfo->startTimeStamp <= (8*60+30))
      ? (8*60+30)
 ...
 { if(gFunDbgFlag){ printf("\n%%OVERTIME-FUN-DBG:%s-%d-%s", __FUNCTION__, 378, "END\n"); }};
 return;
}
